# Generated by Powerlevel10k configuration wizard on 2025-10-21 at 13:21 EEST.
...
() {
  ...
  # Keep right prompt on the first line (status line).
  typeset -g POWERLEVEL9K_RPROMPT_ON_NEWLINE=false

  # Two-line prompt with connectors.
  typeset -g POWERLEVEL9K_PROMPT_ON_NEWLINE=true
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{242}┌─%f '
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{242}│ %f'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{242}└─%f '
